...
let cacheVersion = 0;
export const subscribeDetailCache = (listener: () => void) => {
  cacheListeners.add(listener);
  return () => { cacheListeners.delete(listener); };
};
export const getDetailCacheVersion = () => cacheVersion;
